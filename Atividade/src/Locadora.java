...
//***** Lista 1.2.3 - refactoring2 (Cliente + Locacao)
//import refactoring2.Cliente;
//import refactoring2.Locacao;
//import original.Automovel;

//***** Lista 1.2.4 - refactoring3 (Cliente + Locacao + Automovel)
...
public class Locadora {
	public static void main(String[] args) {
		...
		c1.adicionaLocacao(new Locacao(new Automovel("BMW Serie 7", "UBA0808", 2022, Automovel.LUXO), 30));
