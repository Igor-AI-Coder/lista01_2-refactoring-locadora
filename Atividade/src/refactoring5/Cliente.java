...
/**
 * Lista 1.2.6 - Cliente nao muda: continua falando so com Aluguel e Alugavel.
 */
public class Cliente {
	...
	public String extrato() {
		...
		while (alugueis.hasNext()) {
			...
			resultado += "\t" + umaLocacao.getItem().getTitulo() + " (" + umaLocacao.getItem().getAno() + ")"
	...
	public String extratoHTML() {
		...
		while (alugueis.hasNext()) {
			...
			resultado += String.format(new Locale("pt", "BR"),
					...
					sequencia, umaLocacao.getItem().getTitulo(), umaLocacao.getDiasAlugado(),
